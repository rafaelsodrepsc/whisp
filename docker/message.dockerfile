...
RUN mvn dependency:go-offline -pl message-service -q

# copia o código e compila
COPY message-service/src message-service/src
RUN mvn clean package spring-boot:repackage -pl message-service -DskipTests -q
